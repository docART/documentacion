...
En tèrminos generales se puede decir que un prototipo siempre se hace a partir de una propuesta con autor y de un grupo de colaboradores que se vincula al proyecto. En docART estuvimos dsede el primer día los dos impulsores del proyecto (David y Antonio) y los siete colaboradores que se apuntaron en la convocatoria (Anne, Carla, Mariel, Juan, Henrique, Steven). Tambièn fue seleccionada Andreia pero no pudo incorporarse hasta la segunda semana.

La primera reflexión que se hizo tuvo que ver con el reconocimiento de que no es fácil Formar un grupo de trabajo con gentes que no se conocen y que tienen experiencias y competencias muy distintas. Tras unos minutos de discusión estuvimos de acuerdo en que la primera y más importante funciòn del proceso de producción de un prototipo es la emergencia de una comunidad. Esto significa que los resultados que se buscan son tan importantes como el proceso que los produce. tambièn significa, por ejemplo, que debe problematizarse el hecho de que se se distribuyan las tareas por competencias y se construyan equipos fragmentados por "especialidades" que de alguna manera están combatiendo la heterogenidad.
